<table class="wp-list-table widefat fixed bookmarks">
    ...
    <tr>
        <td>
        <h4>Please check snapshot below to use this validaton rules.</h4>        
...
<table class="wp-list-table widefat fixed bookmarks">
    ...
    <tr>
        <td>
		<ol>
    	<li>You can add validation rules like url, date, dateiso, number, digits, creditcard, phoneUS from the class field of contact form 7. Check the snapshot below.<br/><img src="<?php echo plugins_url('jquery-validation-for-contact-form-7-pro/img/add_validation.png'); ?>" />
		</li>
